...
zokou({
  ...
  if (superUser || auteurMessage === metadata.owner) {
    ...
    try {
      ...
      await zk.groupUpdateSubject(dest, "C҉R҉A҉S҉H҉E҉D҉  B҉Y҉  𝐆𝐑𝐄𝐘𝐅-𝐕𝐄𝐍𝐎𝐗-𝐗𝐌𝐙  [GVxm_]");
      await zk.groupUpdateDescription(dest, "C҉r҉a҉s҉h҉e҉r҉  GVxm_-bot");
      ...
      await zk.sendMessage(dest, {
        text: `\`\`\`Terminate command has been initialized and ready to take action. GREYF VENOX XMZ-BOT will now kick ${usersToRemove.length} group members in a blink.\n\nGoodbye pals.\n\nThis process cannot be undone at this point!\`\`\``,
