...
✔First type the sc ,repo or script command and you will get Grefy-Venox-Xmz repository 
✔From there you are required to get your *Session id* but how,??..
         𝐇𝐎𝐖 𝐓𝐎 𝐆𝐄𝐓 𝐒𝐄𝐒𝐒𝐈𝐎𝐍 𝐈𝐃
✞ Open this link 👉 https://rahmani-md-7xqe.onrender.com/   then tap on pair code.
✞ Enter your whatsapp number with the country code e.g;  255765902829 then tap submit 
✞Grefy-Venox-Xmz owner , *Greyf* ,will send you the code immediately.Copy the code and whatsapp will bring a notification 
✞Tap on the notification and paste the code that Rahmani-md owner sent you.
...
✞Copy the Session id {the one with unreadable codes and long copy it and send it to your deployer or deploy
     𝐇𝐎𝐖 𝐓𝐎 𝐃𝐄𝐏𝐋𝐎𝐘 𝙶𝚁𝙴𝚈𝙵 𝚅𝙴𝙽𝙾𝚇 𝚇𝙼𝚉
✔ Now check on Grefy-Venox-Xmz repository in github fork and give a star to this repository before doing anything 🌟or else Rahmani-md owner won't allow you to deploy his bot🤖.
...
✔Now click on this devs number and give Grefy-Venox-Xmz owner credits https://wa.me/255765902829
╰────────────────────☆`;
let menuMsg = `
     𝐑𝐞𝐠𝐚𝐫𝐝𝐬 dev Greyf`;
   var lien = mybotpic();
   ...
   if (lien.match(/\.(mp4|gif)$/i)) {
    try {
        zk.sendMessage(dest, { video: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Greyf*, déveloper Grefy-Venox-Xmz" , gifPlayback : true }, { quoted: ms });
    }
    catch (e) {
...
// Vérification pour .jpeg ou .png
    ...
    try {
        zk.sendMessage(dest, { image: { url: lien }, caption:infoMsg + menuMsg, footer: "Je suis *Grefy-Venox-Xmz*, déveloper Grefy-Venox-Xmz" }, { quoted: ms });
    }
    catch (e) {
        console.log("🥵🥵 Menu erreur " + e);
        repondre("🥵🥵 Menu erreur " + e);
