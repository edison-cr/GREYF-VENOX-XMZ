    ...
    if (mediaUrl) {
      ...
      if (mediaUrl.match(/\.(mp4|gif)$/i)) {
        await zk.sendMessage(dest, {
          ...
          contextInfo: {
            externalAdReply: {
              title: `Grefy-Venox-Xmz Deployer`,
              body: "Premium WhatsApp Bot",
              thumbnailUrl: mediaUrl,
              mediaType: 2,
              mediaUrl: "https://files.catbox.moe/mkho8e.jpg",
              sourceUrl: "https://whatsapp.com/channel/0029VbA5Hlf3gvWdoXqvFr24"
            }
          }
        }, { quoted: ms });
      } 
